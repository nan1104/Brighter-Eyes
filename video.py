...
#from PyQt4.phonon import Phonon PyQt4采用的是Phonon,PyQt5摒弃了，改用PyQt5.QtMultimedia
...
class Player(QDialog):
    ...
    def __init__(self, playlist, parent=None):
        ...
        url = QUrl("眼保健操.avi")
        self.content = QMediaContent(QUrl("眼保健操.avi"))
        ...
        quitButton = QPushButton("Quit", clicked=self.quit)
    ...
    def addToPlaylist(self):
        #这里可以添加多个视频
        nameList = ["眼保健操.avi","小猪佩奇.avi","海浪.avi","海滩晚霞.avi","湖水夕阳.avi","阳光冬河.avi","阳光沙滩.avi"]
        for name in nameList:
            fileInfo = QFileInfo("./src/" + name)
            if fileInfo.exists():
